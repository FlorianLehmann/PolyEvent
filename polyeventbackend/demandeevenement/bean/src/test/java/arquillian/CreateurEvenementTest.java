...
public class CreateurEvenementTest
{

    @EJB
    private DemanderReservation demandeReservation;
    @EJB
    private ValiderReservation validerReservation;
    @EJB
    private CreerEvenement demanderEvenement;
    @PersistenceContext
...
//                .addPackage(Evenement.class.getPackage())
                ...
                .addPackage(CreerEvenement.class.getPackage())

                // Component implementation
                .addPackage(CreateurEvenement.class.getPackage())
    ...
    @Ignore
    @Test
    public void noEvenementByDefault()
    {
        assertEquals(0, 1);
    }
    ...
    @Transactional(TransactionMode.COMMIT)
    @Test
    public void testDemandeReservation()
    {
        final String mail = "jean@f.com";
        Organisateur organisateur = new Organisateur(mail);
        GregorianCalendar now = new GregorianCalendar();
